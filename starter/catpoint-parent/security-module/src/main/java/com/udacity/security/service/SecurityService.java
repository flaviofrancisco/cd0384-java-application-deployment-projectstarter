...
public class SecurityService {
    ...
    /**
     * Checks whether any of the sensors are active and updates the alarm status accordingly.     *
     */
    public  void checkSensors() {
        Set<Sensor> sensors = securityRepository.getSensors();
        if (sensors.stream().anyMatch(sensor -> sensor.getActive())) {
